    ...
    private String dajGreskuHR()
    {
        ...
        switch(this.gr)
        {
            ...
            case VezaNull:
                ...
                break;
            case SesijaNePostoji:
                returnMe = "Niste prijavljeni u sustav. Zabranjen pristup.";
                break;
        }
    ...
    private String dajGreskuEN()
    {
        ...
        switch(this.gr)
        {
            ...
            case VezaNull:
                ...
                break;
            case SesijaNePostoji:
                returnMe = "You are not signed in. Access forbiden";
                break;
        }
    ...
    private String dajGreskuDE()
    {
        ...
        switch(this.gr)
        {
            ...
            case VezaNull:
                ...
                break;
            case SesijaNePostoji:
                returnMe = "Du bist nicht eingeloggt. Zugriff verweigert.";
                break;
        }
