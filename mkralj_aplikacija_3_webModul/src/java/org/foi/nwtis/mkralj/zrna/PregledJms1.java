...
@Named(value = "pregledJms1")
@SessionScoped
public class PregledJms1 implements Serializable
{
    ...
    public String preuzmi()
    {
        ...
        ThreadSafeKolekcija tsKolekcija = upravljanjePorukama.getListaJmsPoruka();
    ...
    {
        upravljanjePorukama.brisiJms(poruka);
        Gson gson = new Gson();
